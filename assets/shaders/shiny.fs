...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    number fac = max(min(2.*sin((length(90.*adjusted_uv) + shiny.r*2.) + 3.*(1.+0.8*cos(length(113.1121*adjusted_uv) - shiny.r*3.121))) - 1. - max(5.-length(90.*adjusted_uv), 0.), 1.), 0.);
    ...
    number fac2 = max(min(5.*cos(shiny.g*0.3 + angle*3.14*(2.2+0.9*sin(shiny.r*1.65 + 0.2*shiny.g))) - 4. - max(2.-length(20.*adjusted_uv), 0.), 1.), 0.);
    number fac3 = 0.3*max(min(2.*sin(shiny.r*5. + uv.x*3. + 3.*(1.+0.5*cos(shiny.r*7.))) - 1., 1.), -1.);
    number fac4 = 0.3*max(min(2.*sin(shiny.r*6.66 + uv.y*3.8 + 3.*(1.+0.5*cos(shiny.r*3.414))) - 1., 1.), -1.);
